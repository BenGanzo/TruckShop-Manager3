...
export default function EditTruckPage() {
  ...
  const onSubmit = async (data: TruckFormData) => {
    ...
    try {
      ...
      if (result.success) {
        toast({ title: 'Truck Updated!', description: 'The truck details have been saved successfully.' });
        router.push('/trucks');
      } else {
        ...
        <div className="grid gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update the primary identification and status information for the
                truck. The Truck ID cannot be changed.
              </CardDescription>
            </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., T-106" {...field} disabled />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
